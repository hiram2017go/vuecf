<template>
    <div class="today">
      <!-- <el-button type="primary" icon="search">已通过查询</el-button> -->
      ...
      <div class="billtable">
        <el-table :data="tableData"   stripe fit>
          ...
          <el-table-column label="上传说明"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.time }}</span>
            </template>
          </el-table-column>
          <el-table-column label="审核状态"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.money }}</span>
            </template>
          </el-table-column>
          <el-table-column label="上传时间"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.mdetails }}</span>
            </template>
          </el-table-column>
          <el-table-column label="上传人"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.mdetails }}</span>
            </template>
          </el-table-column>
          <el-table-column label="上传网段"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.mdetails }}</span>
            </template>
          </el-table-column>
          <el-table-column label="下载网段"  style="text-align: center">
            <template scope="scope">
              <span style="margin-left: 10px">{{ scope.row.mdetails }}</span>
            </template>
          </el-table-column>
